...
$ oc new-project fist-netcore-app

# Add the .NET Core application
$ oc new-app dotnet:7.0-ubi8~https://github.com/granderamirez6/FirstExampleNETCore --context-dir app

# Make the .NET Core application accessible externally and show the url
$ oc expose service first-netcore-app
$ oc get route first-netcore-app
----
